<!DOCTYPE html><html xml:lang="en-GB" lang="en-GB"><head><title>Welcome to Screwfix.com | Power Tools, Electrical, Plumbing Supplies &amp; More | Screwfix Website</title><meta http-equiv="Content-Language" content="en-GB"/><meta http-equiv="Content-Type" content="text/html; charset=utf-8"/><meta name="google" content="nositelinkssearchbox"/><meta name="description" content="Screwfix: Thousands of products at low trade prices | FREE next day delivery available | FREE collection in 5 minutes | 30 day money back guarantee on all orders"/><meta http-equiv="X-UA-Compatible" content="IE=edge"><script type="text/javascript" src="dtagent61_bjnp_8305.js" data-dtconfig="rid=RID_2418|rpid=1642420781|domain=screwfix.com|bandwidth=300|doNotInstrument=mup,blr|reportUrl=dynaTraceMonitor"></script><style>
...
.home-page .banner--var6 .banner__img-align{
    ...
    <link rel="stylesheet" href="assets/css/sfx.min.css">
	<!--[if IE 9]>
	  	<link rel="stylesheet" href="/assets/css/sfx.ie9.min.css">
		<link rel="stylesheet" href="/assets/css/ie9.min.css">
	<![endif]-->
	<link rel="stylesheet" href="assets/css/business.min.css"><style>
@media only screen and (max-width: 64em)
.lg--only {
    display: none;
}
</style><link rel="canonical" href="index.html"/></head><body class="home-page"><script>
	var dataLayer = [{
		'storeName': '',
		'customerId': '2783555196',
		'pageId': 'Home',
	...
	})(window,document,'script','dataLayer','GTM-GNFL');
	</script>
<noscript>
	<iframe src="http://www.googletagmanager.com/ns.html?id=GTM-GNFL" height="0" width="0" style="display:none;visibility:hidden">
	</iframe>
</noscript><div class="super-wrapper"><div class="SiteAboveHeaderMerch1"><!--[if LT IE 10]>
<style>
.iechecker-inner {position: relative;margin: 0 auto;padding: 8px 20px 0;font-size: 13px;line-height: 17px; background-color: #9d9d9d; color: #fff;}
.iechecker-intro img {position: relative;display: block;float: left;margin: 0px 10px 0;}
.iechecker-options ul {position:relative;overflow:hidden;padding:0px 0;clear:both;margin:0}
.iechecker-options li {list-style:none;float:left;width:33%;}
.iechecker-options li img {display:inline-block;width:32px;height:auto;margin:0 10px 0 0;border:0;}
.iechecker-options li a {display:block;font-weight:bold;text-decoration:none;width:95%;text-align:center;padding:0px 20px 10px; color: #fff;}
.iechecker-options li a:hover {text-decoration:underline;}
</style>

<div class="wrp inner iechecker-inner">
    <div class="row inner iechecker-intro">
        <img src="/images/general/assets/gfx/ie-logo.png" width="33" height="33" alt="large IE 8 logo - please update your browser" />
        <p><b>Browser Upgrade Recommended - </b>
		   For an improved experience we recommend you update your browser to the latest version of IE or download one of the below...
        </p>
    </div>
    <div class="row inner iechecker-options">
        <ul class="update-browser">
            <li>
                <a href="http://www.google.com/chrome" target="_blank" title="Install Google Chrome">
                    <img src="/images/general/assets/gfx/chrome-logo.png" alt="Google Chrome logo" />
                    <span>Google Chrome</span>
                </a>
            </li>
            <li>
                <a href="https://www.mozilla.org"  target="_blank" title="Install Mozilla FireFox">
                    <img src="/images/general/assets/gfx/firefox-logo.png" alt="Mozilla Firefox logo" />
                    <span>Firefox</span>
                </a>
            </li>
            <li>
                <a href="http://windows.microsoft.com/en-us/internet-explorer/download-ie" target="_blank" title="Install Internet Explorer">
                    <img src="/images/general/assets/gfx/ie11-logo.png" alt="Microsoft Internet Explorer 11 logo" />
	...
	<div class="sh-wrapper js--site-header">
		...
		<div class="sh-0" style="display: none;">
			<div class="sh-resize">
				...
				<ul class="n">
					<li><span class="flag rg--ie"></span><span class="flag--content"><a href="index.html#">Visit Screwfix.ie</a> - <span id="flag1-prod-num">19,000.00</span>Available online, delivery in 2-3 working days</span></li>
					<li><span class="flag rg--eu"></span><span class="flag--content"><a href="index.html#">Visit Screwfix.eu</a> - <span id="flag1-prod-num">19,000.00</span>Available online, delivery in 2-3 working days</span></li>
					<li><span class="flag rg--de"></span><span class="flag--content"><a href="index.html#">Visit Screwfix.de</a> - <span id="flag1-prod-num">19,000.00</span>Available online, delivery in 2-3 working days</span></li>
					<li><span class="flag rg--uk"></span><span class="flag--content"><a href="index.html#">Visit Screwfix.com</a> - <span id="flag1-prod-num">19,000.00</span>Available online, delivery in 2-3 working days</span></li>
				</ul>
		...
		<div class="sh-header">
			<div class="sh-resize">
				<div class="sh-logo">
					<div class="logo">
						<a id="branding-logo" href="index.html" title="Return to the screwfix.com homepage">
							<img src="assets/gfx/branding/screwfix-logo.svg" data-alt-src="branding/screwfix-logo-small.png" class="logo__screwfix svg-swapper" alt="Screwfix logo" />
						</a>
					</div>
				</div>
				...
				<div class="btn-browse">
					...
					<div class="btn-text">
						Browse <span class="sm-hide">store</span>
					</div>
					<div class="arrow-icon icon-down-dir"></div>
				</div>
							...
							<li class="acc">
								...
								<div class="sh-acc__options">
								    <ul class="sh-acc__opt">
								        ...
								        <li><a id="header_link_sign_out" class="btn btn--primary fill" href="https://www.screwfix.com/?_DARGS=/presentation-web-sitebuilder/jsp/common/siteHeader.jsp_A&_DAV=&_dynSessConf=629939396486544293">Log out</a></li>
								    </ul>
								</div>
							</li>
	...
	<div class="mainSearch__container">
		...
		<script type="text/javascript" language="javascript">
			var searchConfig = {
				...
				searchTextFieldId:'mainSearch-input',
            	...
            	suggestedKeywordTemplate: ' <li>\r\n    <a href="http://www.screwfix.com/\&quot;##SEARCH_URL##\"">\r\n        <strong>##SEARCH_TEXT##</strong>##SUGGESTION_TEXT##\r\n    </a>\r\n</li>',
            	suggestedProductsUrl: '/presentation-web-search/jsp/search/fragments/suggestedProducts.jsp',
            	searchFormUrlPattern: 'http://www.screwfix.com/search',
            	performSearchButton: 'search_submit_button',
            	keyHoverClass: 'sh-search--hover',
...
<div class="row-top--pdg">	<div class="slider slider-banners" data-auto-start="true"		data-slide-speed="5000">				<div>					<div class="hero-radiatortrv">
				...
				<div class="pp__bmsg">Was &#163;149.99</div>
                        ...
                        <div class="hp__banner">
                            <a href="http://www.screwfix.com/help/clickandcollect?cm_sp=homepage-_-service-_-clickcollect" class="hp__cc">
                                <h2>Click &amp; Collect</h2>
                                <p>From any store in 5 Minutes</p>
                            </a>
                        </div>
                    </div>                    <div class="lg-8 md-12 sm-12 cols">
                        <div class="hp__banner">
                            <a href="http://www.screwfix.com/help/delivery?cm_sp=homepage-_-service-_-delivery" class="hp__nd">
                                <h2>Next Day Delivery</h2>
                                <p>FREE DELIVERY <span class="sm-hide">on orders</span> over £50</p>
                            </a>
                        </div>
                    </div>
  <div class="lg-8 md-12 sm-12 cols lg--only">
                        <div class="hp__banner hp__sl">
                            <a href="http://www.screwfix.com/jsp/tradeCounter/tradeCounterPage.jsp" class="hp__sl">
                                <h2>Store Locator</h2>
                                <p>Over 460 stores nationwide</p>
                            </a>
                        </div>
                    </div>
			...
			<div class="lg-9 md-24 sm-24 cols equal">
				<div class="dotd-cont">
					<div class="dotd-inner">
						<a class="banner banner--var6 dot--day" href="http://www.screwfix.com/p/titan-diamond-grit-edged-holesaw-kit-11-pieces/64842?cm_sp=homepage-_-promo-_-dotd64842">
							<div class="banner__wrapper" title="Deal of the Day ends midnight - Titan 11 Piece Diamond Edged Holesaw Kit">
								<div class="banner__content-wrapper">
									<div class="banner__content">
										<div class="clear-flow">
											<div class="dot-header"></div>
										</div>
										<div class="banner__product-panel">
											<p class="banner__prod-title">Titan 11 Piece Diamond Edged Holesaw Kit</p>
										</div>
									</div>
								</div>
								<div class="banner__img-align ">
				...
				<div class="mt__item ssb__color-changer">
					<a href="http://www.screwfix.com/landingpage/springdeals?cm_sp=homepage-_-assortment-_-spring3" class="cat-link" title="View all Spring Savings">
						...
						<div class="mt__item-title">
							<div class="h3">Spring Savings</div>
						</div>
					</a>
				</div>
			</div>
			...
			<div id="68600005" class='lg-8 md-8 sm-24 cols'>
				<div class="mt__item ssb__color-changer">
					<a href="http://www.screwfix.com/landingpage/btt?cm_sp=homepage-_-assortment-_-btt" class="cat-link" title="View all Britain's Top Trade Person ">
						...
						<div class="mt__item-title">
							<div class="h3">Britain's Top Trade Person </div>
						</div>
					</a>
				</div>
			</div>
			...
			<div id="65600020" class='lg-8 md-8 sm-24 cols'>
				<div class="mt__item ssb__color-changer">
					<a href="http://www.screwfix.com/help/rateandreview?cm_sp=homepage-_-assortment-_-review" class="cat-link" title="View all Review a Product and Win £100 of Screwfix Vouchers">
						...
						<div class="mt__item-title">
							<div class="h3">Review a Product and Win £100 of Screwfix Vouchers</div>
						</div>
					</a>
				</div>
			</div>
			...
			<div id="66700008" class='lg-8 md-8 sm-24 cols'>
				<div class="mt__item ssb__color-changer">
					<a href="http://www.screwfix.com/landingpage/newonlinerange/?cm_sp=homepage-_-assortment-_-ore" class="cat-link" title="View all Extended Range Online">
						...
						<div class="mt__item-title">
							<div class="h3">Extended Range Online</div>
						</div>
					</a>
				</div>
			</div>
 ...
 <div class="large">
                        ...
                        <div class="hp-tiles-outer">
                                ...
                                <div class="lg-12 md-12 sm-24 tile-cols">

                                    <a class="tab-mob-link" href="http://www.screwfix.com/landingpage/fixssignin?cm_sp=homepage-_-propositions-_-electricfixsignin"><span></span></a>

                                    <div class="hp-tiles">

                                        <img alt="Electricfix" src="images/general/assets/gfx/electricfix.png" title="Image Title">

                                        <div class="hp-tiles-cont">

                                            <p>Electricfix is a trade only supplier dedicated to meeting the needs of the professional electrical engineer.</p>

                                            <div class="lg-5 lg-offset-7 cols"><a class="btn btn--sm fill" href="http://www.screwfix.com/landingpage/fixssignin?cm_sp=homepage-_-propositions-_-electricfixsignin" title="Sign in to Electricfix">Sign in</a></div>

                                            <div class="lg-5 cols"><a class="btn btn--sm fill" href="http://www.screwfix.com/landingpage/electricfixregister?cm_sp=homepage-_-propositions-_-electricfixregister" title="Register for a new Screwfix account">Register</a></div>
                                ...
                                <div class="lg-12 md-12 sm-24 tile-cols">
                                    ...
                                    <a class="tab-mob-link" href="http://www.screwfix.com/landingpage/fixssignin?cm_sp=homepage-_-propositions-_-plumbfixsignin"><span></span></a>

                                    <div class="hp-tiles">

                                        <img alt="Plumbfix" src="images/general/assets/gfx/plumbfix.png" title="Image Title">

                                        <div class="hp-tiles-cont">

                                            <p>Plumbfix is a trade only supplier dedicated to meeting the needs of the plumbing and heating engineer.</p>

                                            <div class="lg-5 lg-offset-7 cols"><a class="btn btn--sm fill" href="http://www.screwfix.com/landingpage/fixssignin?cm_sp=homepage-_-propositions-_-plumbfixsignin">Sign in</a></div>

                                            <div class="lg-5 cols"><a class="btn btn--sm fill" href="http://www.screwfix.com/landingpage/plumbfixregister?cm_sp=homepage-_-propositions-_-plumbfixregister" title="Register for a new Screwfix account">Register</a></div>
                                ...
                                <div class="lg-12 md-12 sm-24 tile-cols">
                                    ...
                                    <a class="tab-mob-link" href="http://www.screwfix.com/help/tradecreditaccount?cm_sp=homepage-_-propositions-_-tradeuk"><span></span></a>

                                    <div class="hp-tiles">

                                        <img alt="Need a Trade Account?" src="assets/img/banners/homepage/trade-account.png" title="Image Title">

                                        <div class="hp-tiles-cont">


                                            <p>Up to 60 days FREE credit, No Annual Fee, Flexible Credit Limits, Fully Managed Online</p>

                                            <div class="lg-9 cols center"><a class="btn btn--sm fill" href="http://www.screwfix.com/help/tradecreditaccount?cm_sp=homepage-_-propositions-_-tradeuk" title="Apply now">Apply now</a></div>
                                ...
                                <div class="lg-12 md-12 sm-24 tile-cols">
                                    ...
                                    <a class="desk-link" href="http://www.screwfix.com/help/keyaccounts?cm_sp=homepage-_-propositions-_-businessservices"><span></span></a>

                                    <div class="hp-tiles">

                                        <img alt="Key Accounts" src="assets/img/banners/homepage/business-services.png" title="Image Title">
...
<iframe class="survey-frame hide"></iframe>
		<div class="survey-container survey--state-load hide">
		...
		var customerSurvey = function() {
			//if not present in DOM
			if (!$('.survey-container').length) return;
			var cookie_name = "Survey_Cookie"; // stores cookie in variable
			var numbran = Math.round(Math.random() * 9);  // generates numbers between 0 or 9 (1/10) randomly and held in variable numbran
			   //uncomment this if statement to make it random
			if (numbran == "2" && document.cookie.indexOf(cookie_name)== -1) {
				$(document).on('click', '.survey-yes', function() {
					window.open('http://survey.euro.confirmit.com/wix/p480788056.aspx','Survey1','width=800,height=600,toolbar=no,scrollbars=yes,resizable=yes');
					$('.survey-container').fadeOut();
				});
					$(document).on('click', '.survey-no', function() {
					$('.survey-container').fadeOut();
				});
					var lastScrollTop = 0;
				var sc = '.survey-container';
				$(sc).fadeIn().animate({height: "200px"});
				$(window).scroll(function (event) {
						...
						if (st > lastScrollTop) {
							...
							// uproll code
							$(sc).removeClass('survey--state-load');
							$(sc).removeClass('survey--state-down');
					...
					document.cookie=cookie_name+"=1; path=/; expires=Wednesday, 15-Jan-2020 08:00:00 GMT";
			}
		};
     ...
     <a href="http://www.screwfix.com:80/help/mobileapps/" class="" title="Screwfix Apps" >Screwfix Apps</a>
            ...
            </div><div class="row ft-some">
							<div class="lg-24 md-24 sm-24 cols">
								<ul class="n il ft-some__list">
									<li><h2><img src="assets/gfx/svg/connect-with-us.svg" alt="Connect with us" data-alt-src="svg/connect-with-us.png" class="svg-swapper"> </h2></li>
									<li class="some--tw"><a href="https://twitter.com/screwfix" target="_blank"><img src="assets/gfx/svg/some-icons.svg" alt="Screwfix on Twitter" data-alt-src="svg/some-icons.png" class="svg-swapper"></a></li>
									<li class="some--fb"><a href="https://www.facebook.com/Screwfix" target="_blank"><img src="assets/gfx/svg/some-icons.svg" alt="Screwfix on Facebook" data-alt-src="svg/some-icons.png" class="svg-swapper"></a></li>
									<li class="some--yt"><a href="https://www.youtube.com/user/screwfix" target="_blank"><img src="assets/gfx/svg/some-icons.svg" alt="Screwfix on Youtube" data-alt-src="svg/some-icons.png" class="svg-swapper"></a></li>
									<li class="some--fm"><a href="http://community.screwfix.com" target="_blank"><img src="assets/gfx/svg/some-icons.svg" alt="Screwfix Forum" data-alt-src="svg/some-icons.png" class="svg-swapper"></a></li>
									<li class="some--gp"><a href="https://plus.google.com/+screwfix" target="_blank"><img src="assets/gfx/svg/some-icons.svg" alt="Screwfix on Google+" data-alt-src="svg/some-icons.png" class="svg-swapper"></a></li>
								</ul>
							</div>
						</div><div class="row"><div class="lg-9 lg-push-15 md-24 sm-24 cols"><div class="footer__cards">
<p>We accept:</p>
<ul>
<li><span class="cc cc--paypal-md">PayPal</span></li>
<li><span class="cc cc--visa-md">Visa</span></li>
<li><span class="cc cc--visaelec-md">Visa Electron</span></li>
<li><span class="cc cc--maestro-md">Maestro</span></li>
<li><span class="cc cc--master-md">Master Card</span></li>
<li><span class="cc cc--trade-md">Trade Card</span></li>
</ul>
</div></div><div class="lg-15 lg-pull-9 md-24 sm-24 cols"><div class="footer__menu"><ul><li><a href="http://www.screwfix.com:80/help/privacypolicy" title="Privacy Policy">Privacy Policy</a>
</li><li><a href="http://www.screwfix.com:80/help/cookiespolicy" title="Cookie Policy">Cookie Policy</a>
</li><li><a href="http://www.screwfix.com:80/help/termsandconditions" title="Terms &amp; Conditions">Terms &amp; Conditions</a>
</li><li><a href="http://www.screwfix.com:80/help/websitetermsandconditions" title="Website Terms &amp; Conditions">Website Terms &amp; Conditions</a>
</li></ul></div><p class="footer__blurb">
<span>© Copyright Screwfix Direct Ltd 2016</span> <span>Company Registration no: 3006378</span> <span>VAT Registered: 232555575</span>
</p></div></div></div></div><script defer="" type="text/javascript" src="http://www.screwfix.com/presentation-web-sitebuilder/js/home.js"></script><script defer="" type="text/javascript" src="assets/js/lib.min.js"></script>
  <script defer="" type="text/javascript" src="presentation-web-sitebuilder/js/browse.js"></script><script></script></body><!-- 106ms (28ms / 3ms / 75ms) | mfwa11 --></html>
